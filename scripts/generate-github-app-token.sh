...
# Store in 1Password
echo "Storing token in 1Password vault '${VAULT_NAME}' as '${TOKEN_NAME}'..."
...
if command -v op &> /dev/null; then
    ...
    echo "Token stored successfully in 1Password!"
    echo ""
    echo "To use this token:"
    echo "  export TOKEN=\$(op read \"op://${VAULT_NAME}/${TOKEN_NAME}/password\")"
    echo ""
