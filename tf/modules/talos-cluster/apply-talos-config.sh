...
echo "::group::Load Talos secrets from 1Password"
# Secrets are generated by Terraform and stored in 1Password
SECRETS_FILE="${SCRIPT_DIR}/secrets.yaml"
op item get "${cluster_name:-}-machine-secrets" --vault "${vault_name:-}" --fields notesPlain >"$SECRETS_FILE"
echo "Loaded machine secrets from 1Password"
echo "::endgroup::"
